...
const character = new Character('Clank', 'robot')
...
class Player extends Character {
  ...
  defend = function(ammount) {
    this.healthLevel -= ammount;
...
class Hero extends Player {
  ...
  addSuperPower = function(power) {
    this.superPowers.push(power);
  }

  useSuperPower = function(index) {
...
fireSpitter.addSuperPower('fire')
fireSpitter.addSuperPower('spit fire')
